...
CUDA_VISIBLE_DEVICES=2,3,4,5 vllm serve $MODEL_PATH --tensor-parallel-size 4 --host 0.0.0.0 --port 6003 --disable-log-requests &
# CUDA_VISIBLE_DEVICES=0 vllm serve $MODEL_PATH --tensor-parallel-size 1 --host 0.0.0.0 --port 6001 --disable-log-requests &
